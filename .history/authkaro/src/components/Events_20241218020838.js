...
function Events({ user }) {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://cold-cassandra-backendsforpracticealltheverybestrukja-1e03db87.koyeb.app/events"
        );
  ...
  const handleFilter = async () => {
    try {
      const response = await fetch(
        "https://cold-cassandra-backendsforpracticealltheverybestrukja-1e03db87.koyeb.app/filter",
        {
          method: "POST",
          headers: {
