...
function Works() {
  return (
    <div className="bg-black flex flex-col pb-[5rem]">
      <div className="Home_text__2lcsE">
        ...
        <p className="text-xl text-center pt-3">
          We Make You<span className="text-pink-400 font-bold"> Nightlife</span>{" "}
          Easy
        </p>
      </div>
      <div className="Home_cards__1n2Km flex justify-center gap-[7rem] items-center pt-9 mx-10">
        ...
        <div className="Home_card__YH5o_ flex flex-col items-center gap-[2rem] justify-center">
          ...
          <div className="Home_box__2BVaQ flex flex-col items-center">
            <h1 className="text-4xl">
              Find Your{" "}
              <span className="Home_t1__1CETv text-pink-400">Venue</span>
            </h1>
            <span className="pt-3 text-base text-gray-500">
              Discover your perfect event, effortlessly
            </span>
        ...
        <div className="Home_card__YH5o_ flex flex-col items-center gap-[2rem] justify-center">
          ...
          <div className="Home_box__2BVaQ flex flex-col items-center">
            <h1 className="Home_title__2gqoF text-4xl">
              Pay{" "}
              <span className="Home_t1__1CETv text-pink-400">Effortlessly</span>
            </h1>
            <span className="pt-3 text-base text-gray-500">
      ...
      <div className="py-10 flex justify-center">
        <button
          className="btn px-6 py-3 mx-auto"
